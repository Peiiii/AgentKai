import { FileSystem, EnvProvider, PathUtils, PlatformInfo, PlatformServices, PlatformServiceFactory, PlatformType } from './interfaces';

/**
 * 浏览器环境的文件系统实现，使用IndexedDB
 */
export class BrowserFileSystem implements FileSystem {
  private readonly DB_NAME = 'agentkai-fs';
...
export class BrowserPlatformServices implements PlatformServices {
  ...
  fs: FileSystem = new BrowserFileSystem();
 ...
 * 浏览器环境的平台服务工厂
 */
export class BrowserPlatformServiceFactory implements PlatformServiceFactory {
